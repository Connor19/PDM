...
/**
 * Created by FRANZ on 09/04/2016.
 */
    ...
    protected String doInBackground(String... arg0) {
        ...
        if(byGetOrPost == 0){ //means by Get Method
            try{
                ...
                String link = "http://frzasd.esy.es/laboratorio8/methodGET.php?usuario="+username+"&clave="+password;
            ...
            try{
                String username = (String)arg0[0];
                String password = (String)arg0[1];
                String link="http://frzasd.esy.es/laboratorio8/methodPOST.php";
